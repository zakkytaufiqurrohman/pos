            ...
            <form action="{{ route('barang.store')}}" method="post">
                ...
                <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_barang" name="nama_barang" class="form-control{{ $errors->has('nama_barang') ? ' is-invalid' : '' }}" name="nama_barang" value="{{ old('nama_barang') }}" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_supliyer" id="supliyer" >
                                @foreach ($supliyer as $item)
                                    <option value="{{$item->id_supliyer}}">{{$item->nama_supliyer}}</option>
                                @endforeach
